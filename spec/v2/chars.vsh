...
function mode.ctrl() { store &() { break } /v/modes/viper/ctrl_q }
function apply(ch) { exec /v/modes/viper/:{ch}; exec /v/views/viper/:{ch} }
function install() { mode.keys.alpha; mode.keys.punct; view.keys.alpha; view.keys.punct; mode.keys.space; view.keys.space; mode.ctrl }
