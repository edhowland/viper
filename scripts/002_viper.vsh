...
_mode=viper bind move_shift_home { start_of_line :_buf } { at :_buf }
...
ignore_undo meta_n
_mode=viper bind ins_at &(data) { ch=:(echo -n :data | xfkey -r); ins_at :_buf :ch } &(data) { name=:(echo -n :data | xfkey -h); echo -n :name }
